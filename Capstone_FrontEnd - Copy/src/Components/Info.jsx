  ...
  //     console.log(currentRouteFrom);
  //     console.log(currentRouteTo);
  //     console.log(seatDetails)
  ...
  //       const isOverlapping =
  //       (seatBookedFrom < currentRouteTo && seatBookedTo > currentRouteFrom) || // General overlap check
  //       (seatBookedFrom >= currentRouteFrom && seatBookedFrom < currentRouteTo) || // Starts within current route
  //       (seatBookedTo > currentRouteFrom && seatBookedTo <= currentRouteTo) || // Ends within current route
  //       (seatBookedFrom <= currentRouteFrom && seatBookedTo >= currentRouteTo); // Encompasses current route
  ...
  const isBlocked = seatDetails.some((seatDetail) => {
    ...
    const isOverlapping =
      ...
      (seatBookedFrom >= currentRouteFrom && seatBookedTo <= currentRouteTo) || // Completely inside
      (seatBookedFrom <= currentRouteFrom && seatBookedTo >= currentRouteTo) || // Completely outside
      (seatBookedFrom > currentRouteFrom && seatBookedFrom < currentRouteTo) || // From within
      (seatBookedTo > currentRouteFrom || seatBookedTo < currentRouteTo); // To within
  ...
  // Check if the current booking starts immediately after or ends immediately before an existing booking
  ...
  //   const currentRouteFrom = from;
  //   const currentRouteTo = to;
  //   console.log(`Current route: ${currentRouteFrom} to ${currentRouteTo}`);
  //   console.log(seatDetails);
  ...
  //     const isOverlapping = !(currentRouteTo <= seatBookedFrom || currentRouteFrom >= seatBookedTo);

  //     console.log(`Checking seat: ${seat.toString()} on route: ${seatBookedFrom} to ${seatBookedTo} - Overlapping: ${isOverlapping}`);
  ...
  //     const seatBookedFrom = seatDetail.from;
  //     const seatBookedTo = seatDetail.to;
  //     const bookingDate = new Date(seatDetail.bookingDate).toLocaleDateString();

  //     // Check if the booking segment overlaps with the current segment
  //     const isOverlapping = 
  //       (seatBookedFrom < currentRouteTo && seatBookedTo > currentRouteFrom);
