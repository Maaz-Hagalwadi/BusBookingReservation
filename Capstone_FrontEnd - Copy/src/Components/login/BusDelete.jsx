...
function BusDelete() {
    ...
    return (
        <Container fluid>
            <h1 style={{textAlign:'center',color:'#ca5252',fontWeight:'bold'}}>Remove a Bus</h1>
            {loading ? (
                ...
                <Form onSubmit={handleFormSubmit}style={{ maxWidth: '400px', margin: 'auto' }}>
                    ...
                    <Button variant="primary" type="submit" style={{backgroundColor:'#ca5252',border:'2px solid black',margin:'auto',width:'3x0%'}}>
                        Delete
                    </Button>
                </Form>
            )}
