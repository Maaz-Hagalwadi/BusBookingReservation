...
const Bus = () => {
  ...
  {/* <div style={{width:'70%',height:'10%'
    ...
    */}
     ...
     <div style={{width:'1200px',border:'2px solid red',maxWidth:'600px'}}> 
     <MapContainer>
...
{/* //from here */}
                   <div className="d-flex justify-content-between mb-1" >
                      <div className="card-text" style={{ fontSize: '1rem',fontWeight:'bold' }}>
                        {isSearchPerformed ? (
                      ...
                      <div><small className="text-muted"style={{color:'black',fontWeight:'bold',fontSize:'21px'}}> {bus.Route?.departure}----</small>
                      ...
                      <div className="card-text" style={{ fontSize: '0.9rem' }}>
                        <small className="text-muted" style={{color:'black',fontWeight:'bold',fontSize:'16px'}}> {bus.busType}</small><br />
...
// import MapPage from './BusMap'; // Adjust import name to match your file structure
// import { MapContainer } from 'react-leaflet';
...
// const Bus = () => {
//   const [pickup, setPickup] = useState('Bangalore'); // Default value for testing
//   const [dropoff, setDropoff] = useState('Honnavar'); // Default value for testing
//   const [date, setDate] = useState('');
//   const [buses, setBuses] = useState([]);
//   const [isLoading, setIsLoading] = useState(false);
//   const [error, setError] = useState(null);
...
//       <div style={{width:'100%',height:'10%'}}> <MapPage from={pickup} to={dropoff} /></div>
...
//                       </div>
//                       <div>
//                         <small className="text-muted" style={{ color: 'black', fontWeight: 'bold', fontSize: '21px' }}> {bus.Route?.departure}</small>
//                         <small className="text-muted" style={{ color: 'black', fontWeight: 'bold', fontSize: '21px' }}> {bus.Route?.arrival}</small>
//                       </div>
//                       <div className="card-text" style={{ fontSize: '0.9rem' }}>
//                         <small className="text-muted" style={{ color: 'black', fontWeight: 'bold', fontSize: '16px' }}> {bus.busType}</small><br />
//                       </div>
...
//                     <div className="d-flex justify-content-between">
//                       <p className="card-text" style={{ fontSize: '0.9rem' }}>Fare: Rs {bus.fare}</p>
//                       <p className="card-text" style={{ fontSize: '0.9rem' }}>Seats Available: {bus.seatsAvailable}</p>
//                     </div>
//                   </div>
...
//                       style={{ backgroundColor: 'orange', color: 'white', borderRadius: '5px', padding: '10px', fontWeight: 'bold', border: 'none' }}
//                     >
//                       Book Now
//                     </button>
//                   </div>
